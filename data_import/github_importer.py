        ...
        try:
            ...
            for repo in repositories:
                ...
                try:
                    ...
                    self.logger.warning(
                        f"Failed to fetch data for repository {repo_name}: {e}"
                    )
                    continue
    ...
    def transform_data(self, raw_data: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        ...
        for item in raw_data:
            try:
                ...
                self.logger.error(
                    f"Failed to transform item {item.get('id', 'unknown')}: {e}"
                )
                continue
    ...
    def store_data(self, transformed_data: List[Dict[str, Any]]) -> int:
        ...
        for item in transformed_data:
            try:
                ...
                item_name = item.get(
                    "title", item.get("name", item.get("message", item["external_id"]))
                )
