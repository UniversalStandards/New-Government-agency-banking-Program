...
# Feature flags
ENABLE_REGISTRATION = os.environ.get('ENABLE_REGISTRATION', 'true').lower() in ('true', '1', 'yes', 'on')
ENABLE_API = os.environ.get('ENABLE_API', 'true').lower() in ('true', '1', 'yes', 'on')
ENABLE_ANALYTICS = os.environ.get('ENABLE_ANALYTICS', 'true').lower() in ('true', '1', 'yes', 'on')
