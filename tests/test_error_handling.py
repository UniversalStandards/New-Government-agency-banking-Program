...
def test_route_error_handling_with_database_error(app, client):
    ...
    def test_endpoint():
        try:
            ...
            raise Exception("FATAL: password authentication failed for user 'admin' at host '192.168.1.100'")
...
def test_route_error_handling_with_api_error(app, client):
    ...
    def test_endpoint():
        try:
            ...
            raise Exception("API request failed: Invalid API key 'sk_test_abc123xyz' for account 'acct_xyz789'")
        except Exception as e:
...
def test_route_error_handling_with_file_path_error(app, client):
    ...
    def test_endpoint():
        try:
            ...
            raise Exception("FileNotFoundError: [Errno 2] No such file or directory: '/home/admin/.ssh/id_rsa'")
        except Exception as e:
...
def test_service_error_handling():
    ...
    def mock_service_method():
        try:
            ...
            raise Exception("Connection refused: Unable to connect to database at postgresql://user:pass@localhost:5432/gofap")
        except Exception as e:
